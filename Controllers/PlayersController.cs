...
namespace WebAppcore_exercise.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PId,Name,Team")] Players players)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PId,Name,Team")] Players players)
        {
            if (id != players.PId)
            {
                return NotFound();
